...
toleranz         : Gibt einen Wert an, der zu der Breite des Armbands zu addieren ist (Standard 0.6mm)

Alle Werte sind in mm anzugeben!

Beispielaufruf: aufnahme_federsteg(18);
*/

module aufnahme_federsteg (breite_armband, breite_nasen=3, toleranz=0.6) {
    difference() {
